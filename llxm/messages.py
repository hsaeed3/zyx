...
from .types.completions.completions_message import CompletionsMessage
...
def add_context_to_messages(
        messages: Union[List[CompletionsMessage], List[List[CompletionsMessage]]],
        additional_context: any
) -> Union[List[CompletionsMessage], List[List[CompletionsMessage]]]:
    """
    ...
    try:
        ...
        raise LLXMException(f"Failed to add content to latest system message: {e}")
