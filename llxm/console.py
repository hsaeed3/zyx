...
# builtins -- llxm swaps out print with rich.print
import builtins
...
class Console(RichConsole):
    ...
    def message(self, message : str):
        """
        Sends llxm message to the console
        ...
        self.print(f"⚛️ [bold plum3]LLXM[/bold plum3] | [cyan]{module}[/cyan] | [white italic]{message}[/white italic]")


    # warning method
    # no exception -- exceptions raised by llxm.exception
    def warning(self, message : str):
        ...
        frame = inspect.currentframe().f_back
        module = frame.f_globals["__name__"]
        self.print(f"⚠️ [bold yellow]LLXM WARNING[/bold yellow] | [yellow]{module}[/yellow] | [yellow italic]{message}[/yellow italic]")
