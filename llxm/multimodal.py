...
def audio(
    ...
    try:
        ...
        logger.critical(
            "The [italic]speak[/italic] function requires sounddevice and soundfile, which are not included in the base 'llxm' package. Please install them with [bold]`pip install sounddevice soundfile`[/bold]."
        )
