...
from zyx.core.chat_completions.helpers import chat_messages as chat_messages_helpers
...
def test_messages_helpers_create_chat_message():
...
def test_messages_helpers_validate_chat_message():
    # Test with dict
...
def test_messages_helpers_convert_to_chat_messages():
    # Test with string
...
def test_messages_helpers_format_or_create_system_chat_message():
...
if __name__ == "__main__":
    test_messages_helpers_create_chat_message()
    test_messages_helpers_validate_chat_message()
    test_messages_helpers_convert_to_chat_messages()
    test_messages_helpers_format_or_create_system_chat_message()
