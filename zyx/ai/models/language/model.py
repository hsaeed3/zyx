...
from ..adapters import ModelAdapter, ModelAdapterName, InstructorModeName
...
__all__ = ["LanguageModel", "llm", "allm"]
...
class LanguageModel(Generic[T]):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            provider: Provider configuration (ModelProviderInfo instance, provider name,
    ...
    def _create_adapter(
        self,
        model: str,
        provider: ModelProviderInfo | ModelProviderName | str | None,
        base_url: str | None,
        api_key: str | None,
        adapter_type: str,
    ) -> ModelAdapter:
        ...
        if provider is None:
            inferred = ModelProvider.infer_model_provider(model_name)
            if inferred is None:
                raise ValueError(
            ...
            async def _stream_wrapper():
                ...
                async for chunk in chunk_iterator:
                    ...
                    yield LanguageModelResponse[str](
                        ...
                        provider=self._adapter.provider.name
...
async def allm(
    ...
    **kwargs,
    ...
    """
    Run a language model call.
    When stream=False (default), returns a single response object.
    """
    ...
...
async def allm(
    ...
    *,
    ...
    settings: LanguageModelSettings | None = None,
    **kwargs,
) -> Iterator[LanguageModelResponse[T]]:
    """
    Run a language model call.
    When stream=True, returns an iterator over response chunks.
    """
    ...
...
async def allm(
    ...
    **kwargs,
    ...
    """Asynchronously run a LanguageModel in one call.
    ...
    Returns:
        LanguageModelResponse or async iterator of responses if streaming
    """
    model: LanguageModel[T] = LanguageModel(
        model=model,
        base_url=base_url,
        api_key=api_key,
        adapter=adapter,
...
def llm(
    ...
    **kwargs,
    ...
    """Run a LanguageModel in one call.
