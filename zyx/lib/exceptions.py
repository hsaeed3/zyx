...
class ZyxError(Exception):
    ...
    def __del__(self):
        console.print(f"📝 [bold red]Traceback:[/bold red] {self.traceback}")
        console.print(f"🙈 [red]OhNoo [bold dark_red]{self.name}[/bold dark_red]Error!!![/red] {self.message}")
...
class Yikes:
    ...
    def __init__(self, message: str):
        self.message = message
        console.print(f"⚠️ [bold yellow]Yikes![/bold yellow] [yellow]Warning:[/yellow] {message}")
