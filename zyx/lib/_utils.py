...
class Constants:
    """
    Constants utility functions & helpers for zyx.
    """

    # [Cache Directory]
    ZYX_CACHE_DIR = ZYX_CACHE_DIR

    # [Config File]
    ZYX_CONFIG_FILE = ZYX_CONFIG_FILE


# [Config Utils]
class ConfigUtils:
    """
    Config utility functions & helpers for zyx.
    """

    # [Core Initializer]
    initialize_zyx = initialize_zyx
    # [Config Helpers]
    get_zyx_config = get_zyx_config
    set_zyx_config = set_zyx_config
    validate_zyx_cache_dir = validate_zyx_cache_dir
    validate_zyx_config_file = validate_zyx_config_file


# [Flags]
class Flags:
    """
    Flags utility functions & helpers for zyx.
    """

    # [Flags]
    zyx_verbose = zyx_verbose
    zyx_debug = zyx_debug
