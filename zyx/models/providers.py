...
class ModelProvider:
    ...
    def is_local(self) -> bool:
        ...
        return not self.api_key_required and self.api_key_default is not None
...
class ModelProviderRegistry:
        ...
        self._PROVIDERS = {
            ...
            "cohere": ModelProvider(
                ...
                supported_prefixes=ModelProviderSupportedPrefixes(
                    language_model=frozenset({"command-", "xlarge-", "base-"})
                ),
            ),
    ...
    def infer_from_model_name(
        self,
        model: str,
        kind: Literal["language_model", "embedding_model"] = "language_model",
    ) -> ModelProvider | None:
        ...
        for provider in self._PROVIDERS.values():
            for prefix in provider.supported_prefixes.get(kind, frozenset()):
