...
PydanticAIMessageAdapter: TypeAdapter[_pydantic_ai_messages.ModelMessage] = (
...
def parse_openai_like_to_message(
    message: BaseModel | Dict[str, Any] | Any,
    ...
    if role == "system":
        if isinstance(content, str):
            return _pydantic_ai_messages.ModelRequest(
                parts=[_pydantic_ai_messages.SystemPromptPart(content=content)]
            )
            ...
            for part in content:
                ...
                if part.get("type") == "text":
                    parts.append(
                        _pydantic_ai_messages.SystemPromptPart(content=part["text"])
                    )
        ...
        if isinstance(content, str):
            return _pydantic_ai_messages.ModelRequest(
                parts=[_pydantic_ai_messages.UserPromptPart(content=content)]
            )
            ...
            for part in content:
                ...
                if part["type"] == "text":
                    ...
                    parts.append(
                        _pydantic_ai_messages.ImageUrl(
                    ...
                    parts.append(
                        _pydantic_ai_messages.BinaryContent(
            ...
            return _pydantic_ai_messages.ModelRequest(
                parts=[_pydantic_ai_messages.UserPromptPart(content=parts)]
            )
        ...
        if content is not None:
            if isinstance(content, str):
                parsed_content.append(
                    _pydantic_ai_messages.TextPart(content=content)
                )
                ...
                for part in content:
                    if part.get("type") == "text":
                        parsed_content.append(
                            _pydantic_ai_messages.TextPart(content=part["text"])
                        )
        ...
        if isinstance(content, str):
            return _pydantic_ai_messages.ModelRequest(
                parts=[
                    _pydantic_ai_messages.ToolReturnPart(
                        tool_name=message["name"], content=content
                    )
                ]
            )
            ...
            return _pydantic_ai_messages.ModelRequest(
                parts=[
                    _pydantic_ai_messages.ToolReturnPart(
                        tool_name=message["name"], content=parts
                    )
                ]
            )
...
def parse_string_to_messages(text: str) -> List[_pydantic_ai_messages.ModelMessage]:
            ...
            if untagged:
                messages.append(
                    _pydantic_ai_messages.ModelRequest(
                        parts=[_pydantic_ai_messages.UserPromptPart(untagged)]
                    )
                )
        ...
        if content:
            if role == "system":
                messages.append(
                    _pydantic_ai_messages.ModelRequest(
                        parts=[
                            _pydantic_ai_messages.SystemPromptPart(content=content)
                        ]
                    )
                )
            elif role == "user":
                ...
                messages.append(
                    _pydantic_ai_messages.ModelResponse(
                        parts=[_pydantic_ai_messages.TextPart(content=content)]
                    )
                )
    ...
    if last_end < len(text):
        ...
        if remaining:
            ...
            if unclosed_match:
                ...
                if content:
                    if role == "system":
                        messages.append(
                            _pydantic_ai_messages.ModelRequest(
                                parts=[
                                    _pydantic_ai_messages.SystemPromptPart(
                                        content=content
                                    )
                                ]
                            )
                        ...
                        messages.append(
                            _pydantic_ai_messages.ModelRequest(
                                parts=[
                                    _pydantic_ai_messages.UserPromptPart(
                                        content=content
                                    )
                                ]
                            )
                ...
                messages.append(
                    _pydantic_ai_messages.ModelRequest(
                        parts=[_pydantic_ai_messages.UserPromptPart(remaining)]
                    )
                )
    ...
    if not messages and text.strip():
        messages.append(
            _pydantic_ai_messages.ModelRequest(
                parts=[_pydantic_ai_messages.UserPromptPart(text.strip())]
            )
        )
...
def compact_messages(
    ...
    for message in messages:
        ...
        if isinstance(message, _pydantic_ai_messages.ModelRequest) and isinstance(
            last_message, _pydantic_ai_messages.ModelRequest
        ):
            compacted[-1] = _pydantic_ai_messages.ModelRequest(
                parts=list(last_message.parts) + list(message.parts)
            )
        elif isinstance(message, _pydantic_ai_messages.ModelResponse) and isinstance(
            last_message, _pydantic_ai_messages.ModelResponse
        ):
            compacted[-1] = _pydantic_ai_messages.ModelResponse(
                parts=list(last_message.parts) + list(message.parts)
            )
        else:
            compacted.append(message)
