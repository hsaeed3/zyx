...
from .types.completions.base_types import CompletionChatModel, CompletionInstructorMode, Completions
...
def coder(
    instructions: str,
    model: Union[str, CompletionChatModel] = "gpt-4o-mini",
    api_key: Optional[str] = None,
    base_url: Optional[str] = None,
    organization: Optional[str] = None,
    mode: CompletionInstructorMode = "tool_call",
